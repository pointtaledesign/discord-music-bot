...
> Discord music bot, play queue playlists Spotify YouTube 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

🎵 &nbsp;**Multi-platform** — YouTube, Spotify, SoundCloud, Apple Music

📋 &nbsp;**Queue management** — add, remove, shuffle, and loop tracks

🔊 &nbsp;**Volume control** — per-server volume with bass boost EQ
